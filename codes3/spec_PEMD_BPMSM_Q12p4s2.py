...
spec = pyrhonen_procedure_as_function.desgin_specification(
        ...
        ps = ps,
        mec_power = 50e3, # kW
        ExcitationFreq = 2000, # Hz
        ExcitationFreqSimulated = 2000, # Hz This sets to DriveW_Freq that is actually used in FE simulation.
        ...
        Coil = 'Cu',
        space_factor_kCu = 0.5, # Stator slot fill/packign factor | FEMM_Solver.py is not consistent with this setting
        Conductor = 'Cu',
        space_factor_kAl = 1.0, # Rotor slot fill/packing factor | FEMM_Solver.py is not consistent with this setting
        Temperature = 75, # deg Celsius | FEMM_Solver.py is not consistent with this setting
