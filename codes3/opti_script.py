...
#~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~
exec(compile(open('D:/OneDrive - UW-Madison/c/codes/default_setting.py').read(), 'D:/OneDrive - UW-Madison/c/codes/default_setting.py', 'exec')) # Absolute path is needed for running in JMAG
