...
dir_csv_output_folder = "D:/OneDrive - UW-Madison/c_obsolete/csv_opti/" # 2018
...
# for individual_index in range(20, 44):
    ...
    model_name = "%s_ID%s" % (model_name_prefix, ID)
    original_study_name = model_name + "Freq_#%s" % (ID)
    tran_study_name = "Tran_%s-%dHz"%(ID, int(DriveW_Freq))
    ecrot_study_name = "Freq_#%s" % (ID) + "-FFVRC" # FixFreqVaryRotCon
